...
class MigrationValidator:
    ...
    def __init__(self, repo_root: Path):
        ...
        self.expected_workflow_files = {
            ...
            # Workflow 2
            "workflows/pdf_to_json/scripts/convert_pdf_to_json.py": "src/pipeline/convert_pdf_to_json.py",
            
            # Workflow 3
            "workflows/metadata_extraction/scripts/generate_metadata_universal.py": "src/pipeline/generate_metadata_universal.py",
            
            # Workflow 4
            "workflows/04_metadata_cache_merge/scripts/merge_metadata_to_cache.py": "src/pipeline/merge_metadata_to_cache.py",
            
            # Workflow 5
            "workflows/metadata_enrichment/scripts/generate_chapter_metadata.py": "src/pipeline/generate_chapter_metadata.py",
            "workflows/metadata_enrichment/scripts/chapter_metadata_manager.py": "src/chapter_metadata_manager.py",
            
            # Workflow 6
            "workflows/base_guideline_generation/scripts/chapter_generator_all_text.py": "src/pipeline/chapter_generator_all_text.py",
            
            # Workflow 7
            "workflows/llm_enhancement/scripts/integrate_llm_enhancements.py": "src/integrate_llm_enhancements.py",
            "workflows/llm_enhancement/scripts/interactive_llm_system_v3_hybrid_prompt.py": "src/interactive_llm_system_v3_hybrid_prompt.py",
            "workflows/llm_enhancement/scripts/metadata_extraction_system.py": "src/metadata_extraction_system.py",
            "workflows/llm_enhancement/scripts/compliance_validator_v3.py": "src/pipeline/compliance_validator_v3.py",
            "workflows/llm_enhancement/scripts/models/analysis_models.py": "src/models/analysis_models.py",
            "workflows/llm_enhancement/scripts/models/__init__.py": "src/models/__init__.py",
            "workflows/llm_enhancement/scripts/phases/content_selection_impl.py": "src/phases/content_selection_impl.py",
            "workflows/llm_enhancement/scripts/phases/content_selection.py": "src/phases/content_selection.py",
            "workflows/llm_enhancement/scripts/phases/__init__.py": "src/phases/__init__.py",
            "workflows/llm_enhancement/scripts/builders/metadata_builder.py": "src/builders/metadata_builder.py",
            "workflows/llm_enhancement/scripts/builders/__init__.py": "src/builders/__init__.py",
        }
        ...
        self.expected_init_files = [
            ...
            "workflows/pdf_to_json/__init__.py",
            ...
            "workflows/base_guideline_generation/scripts/__init__.py",
            "workflows/llm_enhancement/__init__.py",
            "workflows/llm_enhancement/scripts/__init__.py",
            "workflows/llm_enhancement/scripts/builders/__init__.py",
            "workflows/llm_enhancement/scripts/models/__init__.py",
            "workflows/llm_enhancement/scripts/phases/__init__.py",
            "shared/__init__.py",
    ...
    def validate_directory_structure(self) -> bool:
        ...
        required_dirs = [
            ...
            "workflows/pdf_to_json/scripts",
            "workflows/pdf_to_json/input",
            "workflows/pdf_to_json/output",
            ...
            "workflows/base_guideline_generation/scripts",
            "workflows/base_guideline_generation/input",
            "workflows/base_guideline_generation/output",
            "workflows/llm_enhancement/scripts",
            "workflows/llm_enhancement/input",
            "workflows/llm_enhancement/output",
            "workflows/llm_enhancement/scripts/builders",
            "workflows/llm_enhancement/scripts/models",
            "workflows/llm_enhancement/scripts/phases",
            "shared",
            "shared/providers",
            "shared/loaders",
            "shared/prompts",
