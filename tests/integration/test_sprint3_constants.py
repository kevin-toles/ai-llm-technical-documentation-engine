...
class TestNoDuplication:
    ...
    def test_loaders_imports_from_constants(self):
        ...
        GREEN: Update loaders to use 'from workflows.shared.constants import BookTitles'.
        ...
        assert "from workflows.shared.constants import BookTitles" in source, \
            "loaders/content_loaders.py must import BookTitles from workflows.shared.constants"
    ...
    def test_main_file_imports_from_constants(self):
        ...
        has_absolute_import = "from workflows.shared.constants import BookTitles" in source
        has_relative_import = "from .constants import BookTitles" in source
        
        assert has_absolute_import or has_relative_import, \
            "Main file must import BookTitles from constants (either 'from workflows.shared.constants' or 'from .constants')"
