...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.31, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.20, lines 11–18)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.36, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.36, lines 12–19)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.21, lines 5–12)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.20, lines 13–20)*:
```
but they are mostly new to the Python world. And this book isn’t a
replacement for the classics in the field such as Eric Evans’s Domain-
Driven Design or Martin Fowler’s Patterns of Enterprise
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.22, lines 4–11)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.24, lines 19–26)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.36, lines 10–17)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.18, lines 14–20)*:
```
all these questions.
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.34, lines 6–13)*:
```
complex.
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.28, lines 2–9)*:
```
Italic
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.25, lines 8–15)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.25, lines 18–25)*:
```
Addtional Content
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.36, lines 11–18)*:
```
can also happily rely on duck typing.
The abstraction can just mean “the public API of the thing you’re using”—a function name plus
some arguments, for example.
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.76, lines 18–23)*:
```
external state.
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.69, lines 5–12)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.66, lines 2–9)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.74, lines 4–11)*:
```
concerns.
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.56, lines 25–31)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.66, lines 1–8)*:
```
def __hash__(self): 
        return hash(self.reference)
Python’s __eq__ magic method defines the behavior of the class for
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.63, lines 12–19)*:
```
def test_equality(): 
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.66, lines 8–15)*:
```
keys; you can find more info in the Python docs.
For value objects, the hash should be based on all the value attributes,
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.56, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.70, lines 2–9)*:
```
Domain modeling
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.62, lines 27–28)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.64, lines 25–26)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.45, lines 5–9)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.56, lines 20–27)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.91, lines 2–9)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.92, lines 10–17)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.93, lines 8–15)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.103, lines 2–9)*:
```
On Coupling and
Abstractions
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.85, lines 20–27)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.107, lines 2–9)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.90, lines 14–19)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.92, lines 25–30)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.104, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.83, lines 5–12)*:
```
Django ORM example
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.79, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.89, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.107, lines 15–22)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.126, lines 13–20)*:
```
World
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.134, lines 2–9)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.133, lines 13–20)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.129, lines 12–19)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.136, lines 7–14)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.118, lines 19–24)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.114, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.130, lines 15–22)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.119, lines 10–17)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.119, lines 3–10)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.118, lines 10–17)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.139, lines 3–10)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.116, lines 5–12)*:
```
TIP
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.110, lines 13–20)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.160, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.172, lines 6–13)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.171, lines 1–8)*:
```
def __exit__(self, *args):  
        self.rollback()  
    @abc.abstractmethod
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.141, lines 1–8)*:
```
├── service_layer   
│   ├── __init__.py 
│   └── services.py 
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.164, lines 5–12)*:
```
pattern.
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.172, lines 10–17)*:
```
        return super().__enter__()
    def __exit__(self, *args):
        super().__exit__(*args)
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.142, lines 2–9)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.152, lines 4–11)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.153, lines 6–13)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.152, lines 31–33)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.141, lines 24–31)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.172, lines 12–19)*:
```
        super().__exit__(*args)
        self.session.close()  
    def commit(self):  
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.170, lines 23–30)*:
```
    return batchref
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.152, lines 29–33)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.160, lines 24–27)*:
```
    if eta is not None: 
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.199, lines 6–13)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.177, lines 1–8)*:
```
def __enter__(self):
        return self
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.177, lines 2–9)*:
```
        return self
    def __exit__(self, exn_type, exn_value, traceback):
        if exn_type is None:
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.196, lines 3–10)*:
```
class Product:
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.183, lines 8–15)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.180, lines 5–12)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.191, lines 3–10)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.208, lines 28–32)*:
```
    )
    assert version == 2  
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.197, lines 5–12)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.189, lines 16–23)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.176, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.180, lines 9–16)*:
```
For this chapter, probably the best thing to try is to implement a UoW from scratch. The code, as
always, is on GitHub. You could either follow the model we have quite closely, or perhaps
experiment with separating the UoW (whose responsibilities are commit(), rollback(), and
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.191, lines 9–16)*:
```
keep track of who can modify what. Especially when we have
collections in the model as we do (our batches are a collection), it’s a
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.205, lines 23–30)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.180, lines 11–18)*:
```
experiment with separating the UoW (whose responsibilities are commit(), rollback(), and
providing the .batches repository) from the context manager, whose job is to initialize things, and
then do the commit or rollback on exit. If you feel like going all-functional rather than messing
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.259, lines 26–31)*:
```
         uow = FakeUnitOfWork() 
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.239, lines 13–20)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.230, lines 10–17)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.234, lines 25–29)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.234, lines 5–12)*:
```
NOTE
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.265, lines 7–14)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.219, lines 20–21)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.232, lines 8–15)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.214, lines 7–13)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.231, lines 8–15)*:
```
domain/events.py):
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.218, lines 14–21)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.239, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.228, lines 9–16)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.233, lines 1–8)*:
```
domain.
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.267, lines 28–35)*:
```
    def _get(self, sku): 
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.270, lines 7–14)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.290, lines 18–25)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.298, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.271, lines 5–12)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.299, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.290, lines 22–29)*:
```
We know that sometimes things 
will break, and 
we’re choosing to handle that by 
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.278, lines 14–21)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.298, lines 6–13)*:
```
Connascence isn’t bad, but some types of connascence are stronger than others. We want to
have strong connascence locally, as when two classes are closely related, but weak
connascence at a distance.
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.280, lines 17–24)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.267, lines 1–8)*:
```
def _add(self, product: model.Product): 
        raise NotImplementedError 
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.279, lines 18–25)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.279, lines 21–26)*:
```
            results.append(cmd_result)
        else:
            raise Exception(f'{message} was not an Event or Command')
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.278, lines 6–13)*:
```
Imperative mood
Error handling
Fail independently
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.280, lines 15–22)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.355, lines 12–19)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.340, lines 4–11)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.354, lines 11–18)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.319, lines 5–12)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.349, lines 5–12)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.347, lines 1–8)*:
```
DI using classes
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.317, lines 11–18)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.332, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.324, lines 6–13)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.330, lines 5–12)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.322, lines 16–21)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.345, lines 2–9)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.321, lines 9–16)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.361, lines 9–16)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.394, lines 39–46)*:
```
work
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.366, lines 12–19)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.383, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.361, lines 23–29)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.378, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.394, lines 10–17)*:
```
Entity
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.367, lines 5–12)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.361, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.373, lines 7–14)*:
```
        workspace.archive()
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.394, lines 7–14)*:
```
Domain
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.383, lines 28–35)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.371, lines 7–14)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.370, lines 2–9)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.417, lines 12–19)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.421, lines 15–22)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.417, lines 23–30)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.421, lines 19–26)*:
```
        return super().__enter__()
    def __exit__(self, *args):
        super().__exit__(*args)
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.415, lines 8–15)*:
```
│   ├── allocation
│   │   ├── __init__.py
│   │   ├── adapters
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.410, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.411, lines 11–18)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.417, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.434, lines 15–22)*:
```
    return e.code, 400
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.400, lines 26–29)*:
```
      - API_HOST=app
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.430, lines 12–19)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.427, lines 14–19)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.436, lines 17–24)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.460, lines 12–19)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.460, lines 20–24)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.436, lines 5–12)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.442, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.436, lines 4–11)*:
```
"""
class MessageUnprocessable(Exception):  
    def __init__(self, message):
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.452, lines 1–8)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.448, lines 2–9)*:
```
Model
closures
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.448, lines 10–17)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.452, lines 4–11)*:
```
constraints, Invariants, Constraints, and Consistency
context manager, Unit of Work Pattern
starting Unit of Work as, The Unit of Work Collaborates with the
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.437, lines 17–24)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.453, lines 6–13)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.470, lines 10–17)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.470, lines 11–18)*:
```
__enter__ and __exit__, Unit of Work and Its Context Manager
__eq__, Value Objects and Entities
__hash__, Value Objects and Entities
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.468, lines 6–13)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.478, lines 20–24)*:
```
This All So Hard?
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.483, lines 4–11)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.473, lines 2–9)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.493, lines 10–17)*:
```
value objects
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.475, lines 19–24)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.491, lines 2–9)*:
```
Pattern-Wrap-Up
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.496, lines 12–19)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.479, lines 23–25)*:
```
Lunch, Folks
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.471, lines 6–13)*:
```
...
**Verbatim Educational Excerpt** *(Learning Python Ed.6, p.478, lines 4–11)*:
```
Up
...
[^1]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 16, lines 1–25).
[^2]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 31, lines 1–8).
[^3]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 20, lines 11–18).
[^4]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 36, lines 1–8).
[^5]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 36, lines 12–19).
[^6]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 21, lines 5–12).
[^7]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 20, lines 13–20).
[^8]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 22, lines 4–11).
[^9]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 24, lines 19–26).
[^10]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 36, lines 10–17).
[^11]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 18, lines 14–20).
[^12]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 34, lines 6–13).
[^13]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 28, lines 2–9).
[^14]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 25, lines 8–15).
[^15]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 25, lines 18–25).
[^16]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 36, lines 11–18).
[^17]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 45, lines 1–1).
[^18]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 77, lines 1–1).
[^19]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 109, lines 1–1).
[^20]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 45, lines 1–25).
[^21]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 76, lines 18–23).
[^22]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 69, lines 5–12).
[^23]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 66, lines 2–9).
[^24]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 56, lines 7–14).
[^25]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 74, lines 4–11).
[^26]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 56, lines 25–31).
[^27]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 66, lines 1–8).
[^28]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 63, lines 12–19).
[^29]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 66, lines 8–15).
[^30]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 56, lines 1–8).
[^31]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 70, lines 2–9).
[^32]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 62, lines 27–28).
[^33]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 64, lines 25–26).
[^34]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 45, lines 5–9).
[^35]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 56, lines 20–27).
[^36]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 77, lines 1–1).
[^37]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 109, lines 1–1).
[^38]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 141, lines 1–1).
[^39]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 77, lines 1–25).
[^40]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 91, lines 2–9).
[^41]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 92, lines 10–17).
[^42]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 93, lines 8–15).
[^43]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 103, lines 2–9).
[^44]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 85, lines 20–27).
[^45]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 107, lines 2–9).
[^46]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 92, lines 10–17).
[^47]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 90, lines 14–19).
[^48]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 92, lines 25–30).
[^49]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 104, lines 1–8).
[^50]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 83, lines 5–12).
[^51]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 79, lines 1–8).
[^52]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 93, lines 8–15).
[^53]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 89, lines 1–8).
[^54]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 107, lines 15–22).
[^55]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 109, lines 1–1).
[^56]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 141, lines 1–1).
[^57]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 176, lines 1–1).
[^58]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 109, lines 1–25).
[^59]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 126, lines 13–20).
[^60]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 134, lines 2–9).
[^61]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 133, lines 13–20).
[^62]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 129, lines 12–19).
[^63]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 136, lines 7–14).
[^64]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 118, lines 19–24).
[^65]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 114, lines 1–8).
[^66]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 130, lines 15–22).
[^67]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 119, lines 10–17).
[^68]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 119, lines 3–10).
[^69]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 118, lines 10–17).
[^70]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 139, lines 3–10).
[^71]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 116, lines 5–12).
[^72]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 110, lines 13–20).
[^73]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 116, lines 8–15).
[^74]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 141, lines 1–1).
[^75]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 176, lines 1–1).
[^76]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 211, lines 1–1).
[^77]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 141, lines 1–25).
[^78]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 160, lines 1–8).
[^79]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 172, lines 6–13).
[^80]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 171, lines 1–8).
[^81]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 141, lines 1–8).
[^82]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 164, lines 5–12).
[^83]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 172, lines 10–17).
[^84]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 142, lines 2–9).
[^85]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 152, lines 4–11).
[^86]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 153, lines 6–13).
[^87]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 152, lines 31–33).
[^88]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 141, lines 24–31).
[^89]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 172, lines 12–19).
[^90]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 170, lines 23–30).
[^91]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 152, lines 29–33).
[^92]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 160, lines 24–27).
[^93]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 176, lines 1–1).
[^94]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 211, lines 1–1).
[^95]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 266, lines 1–1).
[^96]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 176, lines 1–25).
[^97]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 199, lines 6–13).
[^98]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 177, lines 1–8).
[^99]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 177, lines 2–9).
[^100]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 196, lines 3–10).
[^101]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 183, lines 8–15).
[^102]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 180, lines 5–12).
[^103]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 191, lines 3–10).
[^104]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 208, lines 28–32).
[^105]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 197, lines 5–12).
[^106]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 189, lines 16–23).
[^107]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 176, lines 1–8).
[^108]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 180, lines 9–16).
[^109]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 191, lines 9–16).
[^110]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 205, lines 23–30).
[^111]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 180, lines 11–18).
[^112]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 211, lines 1–1).
[^113]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 266, lines 1–1).
[^114]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 316, lines 1–1).
[^115]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 211, lines 1–25).
[^116]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 259, lines 26–31).
[^117]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 239, lines 13–20).
[^118]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 230, lines 10–17).
[^119]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 234, lines 25–29).
[^120]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 234, lines 5–12).
[^121]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 265, lines 7–14).
[^122]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 219, lines 20–21).
[^123]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 232, lines 8–15).
[^124]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 214, lines 7–13).
[^125]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 231, lines 8–15).
[^126]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 218, lines 14–21).
[^127]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 239, lines 1–8).
[^128]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 228, lines 9–16).
[^129]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 233, lines 1–8).
[^130]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 233, lines 1–8).
[^131]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 266, lines 1–1).
[^132]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 316, lines 1–1).
[^133]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 361, lines 1–1).
[^134]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 266, lines 1–25).
[^135]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 267, lines 28–35).
[^136]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 270, lines 7–14).
[^137]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 290, lines 18–25).
[^138]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 298, lines 1–8).
[^139]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 271, lines 5–12).
[^140]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 299, lines 1–8).
[^141]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 290, lines 22–29).
[^142]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 278, lines 14–21).
[^143]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 298, lines 6–13).
[^144]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 280, lines 17–24).
[^145]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 267, lines 1–8).
[^146]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 279, lines 18–25).
[^147]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 279, lines 21–26).
[^148]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 278, lines 6–13).
[^149]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 280, lines 15–22).
[^150]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 316, lines 1–1).
[^151]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 361, lines 1–1).
[^152]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 396, lines 1–1).
[^153]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 316, lines 1–25).
[^154]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 355, lines 12–19).
[^155]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 340, lines 4–11).
[^156]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 354, lines 11–18).
[^157]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 319, lines 5–12).
[^158]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 355, lines 12–19).
[^159]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 349, lines 5–12).
[^160]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 347, lines 1–8).
[^161]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 317, lines 11–18).
[^162]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 332, lines 1–8).
[^163]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 324, lines 6–13).
[^164]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 330, lines 5–12).
[^165]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 347, lines 1–8).
[^166]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 322, lines 16–21).
[^167]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 345, lines 2–9).
[^168]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 321, lines 9–16).
[^169]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 361, lines 1–1).
[^170]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 396, lines 1–1).
[^171]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 436, lines 1–1).
[^172]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 361, lines 1–25).
[^173]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 361, lines 9–16).
[^174]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 394, lines 39–46).
[^175]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 361, lines 9–16).
[^176]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 366, lines 12–19).
[^177]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 383, lines 1–8).
[^178]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 361, lines 23–29).
[^179]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 378, lines 1–8).
[^180]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 394, lines 10–17).
[^181]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 367, lines 5–12).
[^182]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 361, lines 1–8).
[^183]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 373, lines 7–14).
[^184]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 394, lines 7–14).
[^185]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 383, lines 28–35).
[^186]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 371, lines 7–14).
[^187]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 370, lines 2–9).
[^188]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 396, lines 1–1).
[^189]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 436, lines 1–1).
[^190]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 466, lines 1–1).
[^191]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 396, lines 1–25).
[^192]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 417, lines 12–19).
[^193]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 421, lines 15–22).
[^194]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 417, lines 23–30).
[^195]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 421, lines 19–26).
[^196]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 415, lines 8–15).
[^197]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 410, lines 1–8).
[^198]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 410, lines 1–8).
[^199]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 411, lines 11–18).
[^200]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 421, lines 19–26).
[^201]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 417, lines 1–8).
[^202]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 417, lines 1–8).
[^203]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 434, lines 15–22).
[^204]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 400, lines 26–29).
[^205]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 430, lines 12–19).
[^206]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 427, lines 14–19).
[^207]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 436, lines 1–1).
[^208]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 466, lines 1–1).
[^209]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 436, lines 1–25).
[^210]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 436, lines 17–24).
[^211]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 460, lines 12–19).
[^212]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 460, lines 20–24).
[^213]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 460, lines 12–19).
[^214]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 436, lines 5–12).
[^215]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 442, lines 1–8).
[^216]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 436, lines 4–11).
[^217]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 452, lines 1–8).
[^218]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 436, lines 4–11).
[^219]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 448, lines 2–9).
[^220]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 448, lines 10–17).
[^221]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 452, lines 4–11).
[^222]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 437, lines 17–24).
[^223]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 453, lines 6–13).
[^224]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 436, lines 5–12).
[^225]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 466, lines 1–1).
[^226]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 466, lines 1–25).
[^227]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 470, lines 10–17).
[^228]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 470, lines 11–18).
[^229]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 470, lines 10–17).
[^230]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 468, lines 6–13).
[^231]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 478, lines 20–24).
[^232]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 483, lines 4–11).
[^233]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 473, lines 2–9).
[^234]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 493, lines 10–17).
[^235]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 475, lines 19–24).
[^236]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 491, lines 2–9).
[^237]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 496, lines 12–19).
[^238]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 479, lines 23–25).
[^239]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 471, lines 6–13).
[^240]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 468, lines 6–13).
[^241]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 478, lines 4–11).
[^242]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 501, lines 1–25).
[^243]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 541, lines 1–25).
[^244]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 566, lines 1–25).
[^245]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 601, lines 1–25).
[^246]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 636, lines 1–25).
[^247]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 681, lines 1–25).
[^248]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 721, lines 1–25).
[^249]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 756, lines 1–25).
[^250]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 786, lines 1–25).
[^251]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 821, lines 1–25).
[^252]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 851, lines 1–25).
[^253]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 886, lines 1–25).
[^254]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 921, lines 1–25).
[^255]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 946, lines 1–25).
[^256]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 986, lines 1–25).
[^257]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 1021, lines 1–25).
[^258]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 1061, lines 1–25).
[^259]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 1101, lines 1–25).
[^260]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 1141, lines 1–25).
[^261]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 1181, lines 1–25).
[^262]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 1216, lines 1–25).
[^263]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 1251, lines 1–25).
[^264]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 1286, lines 1–25).
[^265]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 1321, lines 1–25).
[^266]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 1366, lines 1–25).
[^267]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 1411, lines 1–25).
[^268]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 1456, lines 1–25).
[^269]: Lutz, Mark. *Learning Python, 6th Edition*. (JSON `Architecture Patterns with Python.json`, p. 1501, lines 1–25).
